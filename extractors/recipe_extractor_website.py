            ...
            messages=[
                {
                    ...
                    'content': (
                        ...
                        "Extract structured data from the text and organize it as follows:"

                        "1. ingredients:"
                        "   - Identify all ingredients in the text and group them under their respective titles if and only if titles are explicitly mentioned (e.g., 'Achiote Citrus Marinade', 'Corn Tortillas')."
                        "     - For a group with a title, create an object with the key 'title_of_ingredient' for the title and a 'list' key for the associated ingredients."
                        "     - Example:"
                        "       {"
                        "         'title_of_ingredient': 'Corn Tortillas',"
                        "         'list': ["
                        ...
                        "         ]"
                        "       }"
                        "   - If no title is available, add all ingredients to the main list directly."
                        
                        "2. directions:"
                        "   - Identify all steps in the text and group them under their respective titles if and only if titles are explicitly mentioned (e.g., 'Preparation', 'Cooking')."
                        "     - For a group with a title, create an object with the key 'title_of_direction' for the title and a 'list' key for the associated steps."
                        "     - Example:"
                        "       {"
                        "         'title_of_direction': 'Cook the chicken',"
                        "         'list': ["
                        "           'Rub the marinade all over the chicken pieces.',"
                        "           'Preheat the oven to 350°F.'"
                        "         ]"
                        "       }"
                        "   - If no title is available, add all steps to the main list directly."
                        "caution do not add title that is not on the text and do not add any description of the recipe"
                        "3. Ensure the output is formatted as JSON and maintains the order of items as they appear in the text."
